...
def _ngrams(tokens: list[str], n: int) -> Counter[tuple[str, ...]]:
    """Build a multiset of n-grams from a token sequence.

    :param tokens: Whitespace-tokenized text.
    :param n: N-gram width (must be positive).

    :return: Counts keyed by length-``n`` token tuples.
    """
