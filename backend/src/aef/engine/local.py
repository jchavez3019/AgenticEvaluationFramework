...
from aef.adapters.registry import build_dataset_adapter, build_model_adapter
from aef.contracts.metric_result import MetricResult
...
from aef.contracts.run import EvaluationRunResult
...
from aef.engine.pipeline import generate_for_sample, score_for_sample
from aef.metrics.base import Metric
from aef.metrics.registry import build_metric
from aef.observability import get_logger, run_context, timed
...
class LocalEngine:
    ...
    def __init__(self, spec: EngineConfig | None = None) -> None:
        """Hold the optional explicit spec; ``run(...)`` falls back on the request's."""
