...
def plot_main(argv: list[str] | None = None) -> int:
    ...
    The walking-skeleton implementation prints a per-metric histogram
    summary (counts, min, max, mean) to stdout. Plotly figures land in
...
def report_main(argv: list[str] | None = None) -> int:
    ...
    Emits a Markdown summary of the run; an HTML rendering follows in
    a later milestone.
    """
