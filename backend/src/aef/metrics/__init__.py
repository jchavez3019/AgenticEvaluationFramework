...
Importing :mod:`aef.metrics` registers every shipped metric:
...
from aef.metrics.lexical import (
    bleu as _bleu,
)
from aef.metrics.lexical import (
    chrf as _chrf,
...
from aef.metrics.operational import (
    cost as _cost,
)
from aef.metrics.operational import (
    latency as _latency,
...
from aef.metrics.registry import (
    build_metric,
    list_metrics,
    register_metric,
    unregister_metric,
