...
dependencies inside :mod:`aef.contracts` and therefore breaks the
import-cycle that would otherwise form between
:mod:`aef.contracts.adapter_spec`, :mod:`aef.contracts.metric_result`,
:mod:`aef.contracts.run`, and :mod:`aef.contracts.telemetry`.

Public consumers should import from :mod:`aef.contracts` directly; this
